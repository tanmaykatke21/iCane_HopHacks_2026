...
HAZARD_PROMPT = (
    ...
    "cane. Look at the image and analyze the path directly ahead.\n"
    "Rules:\n"
    "- If the path is clear, respond with exactly: CLEAR\n"
    "- If there is a hazard, briefly name it, then give a SHORT action "
    "instruction:\n"
    "  - Hazard on the LEFT side of the path -> tell them to move RIGHT.\n"
    "  - Hazard on the RIGHT side of the path -> tell them to move LEFT.\n"
    "  - Something approaching them head-on (person, vehicle, etc.) -> tell "
    "them to STOP.\n"
    "  - Stairs going UP ahead -> tell them to CLIMB carefully.\n"
    "  - Stairs going DOWN ahead -> tell them to STEP DOWN carefully.\n"
    "  - Any other hazard directly ahead with no clear side -> tell them to "
    "STOP.\n"
    ...
    "Stairs going down ahead. Step down carefully.\n"
    "Pole ahead. Move left.\n"
    "CLEAR"
)
